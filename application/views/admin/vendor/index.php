          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <a href="vendors/add"><button class="btn btn-primary" style="float:right;">Add Vendor</button></a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><a href="<?php echo base_url('admin/vendors/'.$value->id);?>"><i class="fas fa-edit"></i></a><a href="<?php echo base_url('admin/vendors/delete/'.$value->id);?>"><i class="fas fa-trash" style="margin-left:10px;"></i></a></td>
                    </tr>
                    <?php } ?>
                  </tbody>
                </table>
