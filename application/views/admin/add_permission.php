        ...
        <form name="saverolepermission" action="" method="post" id="dataForm" novalidate="novalidate">
          <div class="form-group">
            <div class="row">
              <div class="col-sm-12">
                ...
                <input type="text" class="form-control bg-white valid" name="name" aria-required="true" aria-invalid="false">
          ...
          <table class="table text-center" id="dataTable">
            <thead class="bg-white">
              <tr>
                <th width="20%" style=""><label>
                  <input type="checkbox" id="checkAllCheckbox" name="checkallView" value="1" style="margin:3px;"><span>Check ALL</span>
                  </label>
                </th>
                <th colspan=""><label>
              ...
              $role_id = $this->uri->segment(4);
              	foreach ($allModules as $key => $value) { 
              		...
              		<tr>
		                ...
		                <td><label>
		                  <input type="checkbox" name="view[]" value="<?php echo $value->id ;?>,1" class="checkedViewEditBox" style="margin:3px;"><span>View</span>
		                  </label>
		                </td>
		                <td><label>
		                  <input type="checkbox" name="add[]" value="<?php echo $value->id ;?>,2" class="checkedAllAddBox" style="margin:3px;"><span>Add</span>
		                  </label>
		                </td>
		                <td><label>
		                  <input type="checkbox" name="edit[]" value="<?php echo $value->id ;?>,3" class="checkedAllEditBox" style="margin:3px;"><span>Edit</span>
		                  </label>
		                </td>
		                <td><label>
		                  <input type="checkbox" name="delete[]" value="<?php echo $value->id ;?>,4" class="checkedDeleteEditBox" style="margin:3px;"><span>Delete</span>
		                  </label>
		                </td>
              		</tr>
              <?php	}
