...
<div class="content-wrapper">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><a href="<?php echo base_url('admin/rental-products/'.$value->id);?>"><i class="fas fa-edit"></i></a><a href="<?php echo base_url('admin/rental-products/delete/'.$value->id);?>"><i class="fas fa-trash" style="margin-left:10px;"></i></a></td>
                    </tr>
                    <?php } ?>
                  </tbody>
                </table>
  ...
  <script>
    ...
    $.post('<?=base_url("admin/rental_products/change_status")?>',
    {
      id : $(this).data('id'),
